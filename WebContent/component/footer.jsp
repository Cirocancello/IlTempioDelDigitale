<footer class="bg-dark text-light py-4 mt-5">
    <div class="container">
        <div class="row">
            ...
            <!-- ⭐ SEZIONE 1: Customer Care -->
            <!-- Contiene link informativi utili all’assistenza utente -->
            <div class="col-md-3 mb-3">
                <h6 class="text-uppercase fw-bold">Customer Care</h6>
                <ul class="list-unstyled">
                    <!-- Ogni link usa il contextPath per funzionare in qualsiasi server -->
                    <li>
                        <a class="footer-link paragraph bold"
                           href="<%= request.getContextPath() %>/pagine/faqs.jsp">
                            FAQs
                        </a>
                    </li>
                    <li>
                        <a class="footer-link paragraph bold"
                           href="<%= request.getContextPath() %>/pagine/returns.jsp">
                            Returns
                        </a>
                    </li>
                    <li>
                        <a class="footer-link paragraph bold"
                           href="<%= request.getContextPath() %>/pagine/privacy.jsp">
                            Privacy Policy
                        </a>
                    </li>
                </ul>
            ...
            <!-- ⭐ SEZIONE 2: Logo + Motto + Link Admin -->
            <!-- Parte centrale del footer: branding e accesso area riservata -->
            <div class="col-md-6 text-center mb-3">
                ...
                <!-- ⭐ Link all’area admin -->
                <!-- Non è visibile nella navbar pubblica, ma rimane accessibile dal footer -->
                <p class="small mt-2">
                ...
                <!-- Copyright -->
                <p class="small mb-0">
                    &copy; 2025 Il Tempio Del Digitale - All rights reserved
                </p>
            </div>

            <!-- ⭐ SEZIONE 3: Social -->
            <!-- Link ai social con icone Bootstrap Icons -->
