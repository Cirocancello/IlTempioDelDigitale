...
<div class="container my-5 text-center">
    ...
    <p class="lead">
        La nostra missione è portare innovazione digitale con passione, creatività e affidabilità.
    </p>
</div>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6">
            ...
            <p>
                ...
                Siamo partiti con entusiasmo e oggi continuiamo a crescere, guidati dalla stessa passione.
            </p>
        </div>
        ...
        <div class="col-md-6">
            ...
            <p>
                Il nostro team è composto da giovani esperti e appassionati di tecnologia.
                Ci distinguiamo per la ricerca costante di soluzioni innovative e per un servizio clienti attento.
            </p>

            <ul class="list-group">
                <li class="list-group-item">
                    Servizio clienti e post-vendita sempre a disposizione.
                </li>
                <li class="list-group-item">
                    Orario flessibile (9.30-13 / 14.30-19) dal lunedì al sabato.
                </li>
                <li class="list-group-item">
                    Comodità: siamo facilmente raggiungibili anche con i mezzi pubblici.
                </li>
            </ul>
        </div>
...
<div class="container my-5">
    <div class="row g-4">
        ...
        <div class="col-md-6">
            ...
            <ul class="list-group">
                <li class="list-group-item">Servizio clienti e post-vendita sempre a disposizione.</li>
...
<div class="container text-center my-5">
    ...
    <a href="<%= request.getContextPath() %>/pagine/contatti.jsp"
